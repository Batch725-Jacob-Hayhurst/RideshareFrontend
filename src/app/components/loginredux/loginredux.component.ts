...
export class LoginreduxComponent implements OnInit {
  ...
  constructor(private modalService: BsModalService, private userService: UserService, private http: HttpClient, private authService: AuthService, public router: Router, private addressVerify: AddressVerificationService) {
    this.isLogin = true;
    this.isSignUp = true;
    this.user = new User();
  }
  ...
  // this would be the city from form field
  testCity: string = 'Mountain view';
  // this would be the state from form field
  testState: string = 'CA';
